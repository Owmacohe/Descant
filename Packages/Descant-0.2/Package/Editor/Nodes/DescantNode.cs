...
namespace Descant.Package.Editor.Nodes
{
    /// <summary>
    ...
    public abstract class DescantNode : Node
    {
        ...
        protected void Draw()
        {
            ...
            List<Type> nodeComponents = DescantUtilities.GetAllNodeComponentTypes();
            
            List<string> nodeComponentNames = DescantUtilities.TrimmedNodeComponentTypes(nodeComponents
                .Where(type =>
                    {
                        DescantNodeType tempType = (((NodeTypeAttribute) type.GetCustomAttributes(
            ...
            ComponentDropdown.RegisterValueChangedCallback(callback =>
            {
                ...
                if (componentName != "Add Component")
                {
                    ...
                    if (Components[componentName] >= DescantUtilities.GetNodeComponentMaximum(componentName))
